...
(window.localStorage["zuck-"+l+"-"+a]=JSON.stringify(b))};c.data={};c.internalData={};c.internalData.seenItems=function(a){return h("localStorage")?(a="zuck-"+l+"-"+a,window.localStorage[a]?JSON.parse(window.localStorage[a]):!1):!1}("seenItems")||{};c.add=c.update=function(a,b){var d=e(a,"id"),k=m("#"+l+' [data-id="'+d+'"]'),q="",f=e(a,"items"),g=!1;c.data[d]={};k?g=k:(g=u.createElement("div"),g.className="story");!1===a.seen&&(c.internalData.seenItems[d]=!1,P("seenItems",c.internalData.seenItems));
