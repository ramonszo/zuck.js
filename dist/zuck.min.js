...
b.slideHeight=g("#zuck-modal .story-viewer").offsetHeight;e=v[0];v=h.clientY;f={x:h.clientX,y:v,time:Date.now(),valid:!0};80>v||v>b.slideHeight-80?f.valid=!1:(c.preventDefault(),q=void 0,p={},a.addEventListener("mousemove",m),a.addEventListener("mouseup",u),a.addEventListener("mouseleave",u),a.addEventListener("touchmove",m),a.addEventListener("touchend",u),d&&d.classList.add("paused"),S(),r=setTimeout(function(){d.classList.add("longPress")},600),l=setTimeout(function(){clearInterval(l);l=!1},250))}},
