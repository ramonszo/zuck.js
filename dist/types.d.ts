...
export type ZuckObject = {
    ...
    playVideoItem: (storyViewer?: Maybe<HTMLElement>, elements?: NodeListOf<Element>, unmute?: Event) => void;
    pauseVideoItem: () => void;
    unmuteVideoItem: (video: HTMLVideoElement, storyViewer?: Maybe<HTMLElement>) => void;
};
